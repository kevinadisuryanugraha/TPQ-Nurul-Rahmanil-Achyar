...
<div class="max-w-3xl mx-auto" x-data="{ targetSemua: '1' }">
    <!-- Back Button -->
    <div class="mb-6">
        ...
        <form action="{{ route('admin.pengumuman.store') }}" method="POST" id="pengumuman-form">
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="judul" required value="{{ old('judul') }}" placeholder="Contoh: Pengumuman Libur Hari Raya Idul Fitri"
