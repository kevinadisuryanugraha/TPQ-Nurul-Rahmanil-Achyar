...
@section('title', 'Tulis Cerita Kisah')
@section('page_title', 'Tulis Cerita Kisah Baru')
...
<div class="max-w-4xl mx-auto">
    ...
    <div class="bg-white rounded-2xl border border-gray-200 shadow-sm p-6 sm:p-8">
        <form action="{{ route('admin.konten.cerita.store') }}" method="POST" enctype="multipart/form-data" id="cerita-form">
            @csrf
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="judul" required value="{{ old('judul') }}" placeholder="Contoh: Kisah Kejujuran Nabi Muhammad SAW"
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select name="kategori" required
                            ...
                            <option value="kisah_nabi" {{ old('kategori') == 'kisah_nabi' ? 'selected' : '' }}>Kisah Nabi</option>
                            <option value="kisah_sahabat" {{ old('kategori') == 'kisah_sahabat' ? 'selected' : '' }}>Kisah Sahabat</option>
                            <option value="islami_lainnya" {{ old('kategori') == 'islami_lainnya' ? 'selected' : '' }}>Islami Lainnya</option>
                        </select>
                        @error('kategori')
                            <span class="text-rose-500 text-xs mt-1 block">{{ $message }}</span>
                        @enderror
