...
<head>
    ...
    <title>@yield('title') - Admin LMS TPQ</title>
    <!-- Fonts -->
...
<body class="min-h-screen flex flex-col md:flex-row" x-data="{ sidebarOpen: false }">
    ...
    <aside class="fixed inset-y-0 left-0 z-40 w-64 bg-emerald-900 text-emerald-100 flex flex-col shadow-lg transform transition-transform duration-300 ease-in-out md:translate-x-0 md:static md:inset-auto"
        ...
        <nav class="flex-1 p-4 space-y-1 overflow-y-auto">
            <a href="{{ route('admin.dashboard') }}" class="flex items-center space-x-3 px-4 py-3 rounded-xl hover:bg-emerald-800 transition duration-200 {{ request()->routeIs('admin.dashboard') ? 'bg-emerald-800 text-white font-semibold' : '' }}">
                <i class="fa-solid fa-chart-line w-5"></i>
                <span>Dashboard</span>
            </a>
            <a href="{{ route('admin.murid.index') }}" class="flex items-center space-x-3 px-4 py-3 rounded-xl hover:bg-emerald-800 transition duration-200 {{ request()->routeIs('admin.murid.*') || request()->routeIs('admin.level.index') ? 'bg-emerald-800 text-white font-semibold' : '' }}">
                <i class="fa-solid fa-graduation-cap w-5"></i>
                <span>Data Santri & Level</span>
            </a>
            <a href="{{ route('admin.absensi.index') }}" class="flex items-center space-x-3 px-4 py-3 rounded-xl hover:bg-emerald-800 transition duration-200 {{ request()->routeIs('admin.absensi.*') ? 'bg-emerald-800 text-white font-semibold' : '' }}">
                <i class="fa-solid fa-clipboard-user w-5"></i>
                <span>Input Absensi</span>
            </a>
            <a href="{{ route('admin.penilaian.index') }}" class="flex items-center space-x-3 px-4 py-3 rounded-xl hover:bg-emerald-800 transition duration-200 {{ request()->routeIs('admin.penilaian.*') ? 'bg-emerald-800 text-white font-semibold' : '' }}">
                <i class="fa-solid fa-star w-5"></i>
                <span>Penilaian (4 Domain)</span>
            </a>
            
            <div class="pt-4 border-t border-emerald-800 mt-4 space-y-1">
                <span class="px-4 text-[10px] font-bold text-emerald-300 uppercase block tracking-wider mb-2">Manajemen Konten</span>
                
                <a href="{{ route('admin.konten.doa.index') }}" class="flex items-center space-x-3 px-4 py-2.5 rounded-xl hover:bg-emerald-800 transition duration-200 {{ request()->routeIs('admin.konten.doa.*') ? 'bg-emerald-800 text-white font-semibold' : '' }}">
                    <i class="fa-solid fa-hands-praying w-5"></i>
                    <span class="text-sm">Doa-Doa</span>
                </a>
                <a href="{{ route('admin.konten.hadist.index') }}" class="flex items-center space-x-3 px-4 py-2.5 rounded-xl hover:bg-emerald-800 transition duration-200 {{ request()->routeIs('admin.konten.hadist.*') ? 'bg-emerald-800 text-white font-semibold' : '' }}">
                    <i class="fa-solid fa-book-quran w-5"></i>
                    <span class="text-sm">Hadist</span>
                </a>
                <a href="{{ route('admin.konten.cerita.index') }}" class="flex items-center space-x-3 px-4 py-2.5 rounded-xl hover:bg-emerald-800 transition duration-200 {{ request()->routeIs('admin.konten.cerita.*') ? 'bg-emerald-800 text-white font-semibold' : '' }}">
                    <i class="fa-solid fa-feather-pointed w-5"></i>
                    <span class="text-sm">Cerita Kisah</span>
                </a>
            ...
            <div class="pt-4 border-t border-emerald-800 mt-4 space-y-1">
                <a href="{{ route('admin.pengumuman.index') }}" class="flex items-center space-x-3 px-4 py-3 rounded-xl hover:bg-emerald-800 transition duration-200 {{ request()->routeIs('admin.pengumuman.*') ? 'bg-emerald-800 text-white font-semibold' : '' }}">
                    <i class="fa-solid fa-bullhorn w-5"></i>
                    <span>Kirim Pengumuman</span>
                </a>
                <a href="{{ route('admin.laporan.index') }}" class="flex items-center space-x-3 px-4 py-3 rounded-xl hover:bg-emerald-800 transition duration-200 {{ request()->routeIs('admin.laporan.*') ? 'bg-emerald-800 text-white font-semibold' : '' }}">
            ...
            <div class="pt-4 border-t border-emerald-800 mt-4 space-y-1">
                ...
                <a href="{{ route('admin.landing.pendaftaran.index') }}" class="flex items-center space-x-3 px-4 py-2.5 rounded-xl hover:bg-emerald-800 transition duration-200 {{ request()->routeIs('admin.landing.pendaftaran.*') ? 'bg-emerald-800 text-white font-semibold' : '' }}">
                    <i class="fa-solid fa-id-card-clip w-5"></i>
                    <span class="text-sm">Pendaftaran PSB</span>
                </a>
                <a href="{{ route('admin.landing.galeri.index') }}" class="flex items-center space-x-3 px-4 py-2.5 rounded-xl hover:bg-emerald-800 transition duration-200 {{ request()->routeIs('admin.landing.galeri.*') ? 'bg-emerald-800 text-white font-semibold' : '' }}">
                    <i class="fa-solid fa-images w-5"></i>
                    <span class="text-sm">Galeri Foto</span>
                </a>
                <a href="{{ route('admin.landing.testimoni.index') }}" class="flex items-center space-x-3 px-4 py-2.5 rounded-xl hover:bg-emerald-800 transition duration-200 {{ request()->routeIs('admin.landing.testimoni.*') ? 'bg-emerald-800 text-white font-semibold' : '' }}">
                    <i class="fa-solid fa-comments w-5"></i>
                    <span class="text-sm">Testimoni Wali</span>
                </a>
                <a href="{{ route('admin.landing.pengurus.index') }}" class="flex items-center space-x-3 px-4 py-2.5 rounded-xl hover:bg-emerald-800 transition duration-200 {{ request()->routeIs('admin.landing.pengurus.*') ? 'bg-emerald-800 text-white font-semibold' : '' }}">
                    <i class="fa-solid fa-users-gear w-5"></i>
                    <span class="text-sm">Struktur Pengurus</span>
                </a>
                <a href="{{ route('admin.landing.pengaturan.edit') }}" class="flex items-center space-x-3 px-4 py-2.5 rounded-xl hover:bg-emerald-800 transition duration-200 {{ request()->routeIs('admin.landing.pengaturan.*') ? 'bg-emerald-800 text-white font-semibold' : '' }}">
        ...
        <div class="p-4 bg-emerald-950 border-t border-emerald-800 flex items-center justify-between">
            <div class="flex items-center space-x-3 min-w-0">
                ...
                <div class="min-w-0">
                    ...
                    <span class="text-[10px] text-emerald-300 font-medium truncate block">Ustadz/Pengurus</span>
                </div>
            </div>
